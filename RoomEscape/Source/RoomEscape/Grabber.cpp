...
void UGrabber::BeginPlay()
{
	...
	FVector FirstPlayerLocation;// Empty vector
	FRotator FirstPlayerRotation;// Empty Rotator

	GetWorld()->GetFirstPlayerController()->GetPlayerViewPoint(FirstPlayerLocation,FirstPlayerRotation);// this allows me to get a return of location and rotation need to find something to sotre it in tho.
